...
import (
	...
	releasemanager "go.medium.engineering/picchu/controllers/releasemanager"
...
func (m *MockIncarnations) alertable() []*releasemanager.Incarnation {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "alertable")
	ret0, _ := ret[0].([]*releasemanager.Incarnation)
	return ret0
}
...
func (m *MockIncarnations) deployed() []*releasemanager.Incarnation {
	m.ctrl.T.Helper()
...
func (m *MockIncarnations) releasable() []*releasemanager.Incarnation {
	m.ctrl.T.Helper()
...
func (m *MockIncarnations) revisioned() []*releasemanager.Incarnation {
	m.ctrl.T.Helper()
...
func (m *MockIncarnations) sorted() []*releasemanager.Incarnation {
	m.ctrl.T.Helper()
...
func (m *MockIncarnations) unreleasable() []*releasemanager.Incarnation {
	m.ctrl.T.Helper()
...
func (m *MockIncarnations) unretirable() []*releasemanager.Incarnation {
	m.ctrl.T.Helper()
...
func (m *MockIncarnations) willRelease() []*releasemanager.Incarnation {
	m.ctrl.T.Helper()
