...
// Source: go.medium.engineering/picchu/controllers/releasemanager (interfaces: Deployment)
...
func (m *MockDeployment) getExternalTestStatus() releasemanager.ExternalTestStatus {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "getExternalTestStatus")
	ret0, _ := ret[0].(releasemanager.ExternalTestStatus)
	return ret0
}
