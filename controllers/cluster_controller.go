...
// +kubebuilder:rbac:groups=external-secrets.io,resources=clustersecretstores,verbs=create;get;list;patch;update;watch
// +kubebuilder:rbac:groups=external-secrets.io,resources=externalsecrets,verbs=create;get;list;patch;update;watch
// +kubebuilder:rbac:groups=external-secrets.io,resources=externalsecrets/status,verbs=create;get;list;patch;update;watch
// +kubebuilder:rbac:groups=external-secrets.io,resources=externalsecrets/finalizers,verbs=create;get;list;patch;update;watch
	...
	if !instance.IsDeleted() {
		...
		if !instance.Spec.Enabled {
			...
			if secret != nil {
				...
				reqLogger.Info("Setting status", "instance.Status", instance.Status)
				instance.Status = picchuv1alpha1.ClusterStatus{
