...
// Source: go.medium.engineering/picchu/controllers (interfaces: Incarnations)
//
// Generated by this command:
//
//	mockgen --build_flags=--mod=mod -destination=controllers/mock_incarnations.go -package=controllers go.medium.engineering/picchu/controllers Incarnations
//
...
func (mr *MockIncarnationsMockRecorder) update(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
