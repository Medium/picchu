...
//
//	mockgen --build_flags=--mod=mod -destination=controllers/scaling/mocks/scalabletarget_mock.go -package=mocks go.medium.engineering/picchu/controllers/scaling ScalableTarget
//
...
func (mr *MockScalableTargetMockRecorder) CanRampTo(arg0 any) *gomock.Call {
