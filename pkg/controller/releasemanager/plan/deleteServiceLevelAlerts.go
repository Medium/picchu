...
type DeleteServiceLevelAlerts struct {
	App       string
	Namespace string
}

func (p *DeleteServiceLevelAlerts) Apply(ctx context.Context, cli client.Client, scalingFactor float64, log logr.Logger) error {
