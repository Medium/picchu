...
func (p *SyncApp) publicAuthorityMatch(
	log logr.Logger,
	port picchuv1alpha1.PortInfo,
	cluster *picchuv1alpha1.Cluster,
) *istio.StringMatch {
...
func (p *SyncApp) privateAuthorityMatch(
	log logr.Logger,
	port picchuv1alpha1.PortInfo,
	cluster *picchuv1alpha1.Cluster,
) *istio.StringMatch {
...
func (p *SyncApp) devRoutes(cluster *picchuv1alpha1.Cluster) []*istio.HTTPRoute {
	var routes []*istio.HTTPRoute
	if cluster.Spec.EnableDevRoutes && cluster.Spec.DevRouteTagTemplate != "" &&
		p.DevRoutesServiceHost != "" && p.DevRoutesServicePort > 0 {
