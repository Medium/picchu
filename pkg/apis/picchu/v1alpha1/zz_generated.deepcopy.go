...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExternalTesting) DeepCopyInto(out *ExternalTesting) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExternalTesting.
func (in *ExternalTesting) DeepCopy() *ExternalTesting {
	if in == nil {
		return nil
	}
	out := new(ExternalTesting)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RevisionTarget) DeepCopyInto(out *RevisionTarget) {
	*out = *in
	...
	out.ExternalTesting = in.ExternalTesting
	return
}
