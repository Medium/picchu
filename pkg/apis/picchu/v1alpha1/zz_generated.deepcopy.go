...
func (in *HTTPFaultInjection_Abort) DeepCopyInto(out *HTTPFaultInjection_Abort) {
	*out = *in
	if in.ErrorType != nil {
		...
		*out = new(HTTPFaultInjection_Abort_ErrorType)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTPFaultInjection_Abort_ErrorType) DeepCopyInto(out *HTTPFaultInjection_Abort_ErrorType) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPFaultInjection_Abort_ErrorType.
func (in *HTTPFaultInjection_Abort_ErrorType) DeepCopy() *HTTPFaultInjection_Abort_ErrorType {
	if in == nil {
		return nil
	}
	out := new(HTTPFaultInjection_Abort_ErrorType)
...
func (in *HTTPFaultInjection_Delay) DeepCopyInto(out *HTTPFaultInjection_Delay) {
	*out = *in
	if in.HttpDelayType != nil {
		in, out := &in.HttpDelayType, &out.HttpDelayType
		*out = new(HTTPFaultInjection_Delay_DelayType)
		(*in).DeepCopyInto(*out)
	}
	if in.Percentage != nil {
		in, out := &in.Percentage, &out.Percentage
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTPFaultInjection_Delay_DelayType) DeepCopyInto(out *HTTPFaultInjection_Delay_DelayType) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPFaultInjection_Delay_DelayType.
func (in *HTTPFaultInjection_Delay_DelayType) DeepCopy() *HTTPFaultInjection_Delay_DelayType {
	if in == nil {
		return nil
	}
	out := new(HTTPFaultInjection_Delay_DelayType)
...
func (in *LocalityLoadBalancerSetting) DeepCopyInto(out *LocalityLoadBalancerSetting) {
	*out = *in
	if in.Distribute != nil {
		...
		*out = make([]*LocalityLoadBalancerSetting_Distribute, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
	...
	if in.Failover != nil {
		...
		*out = make([]*LocalityLoadBalancerSetting_Failover, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LocalityLoadBalancerSetting_Distribute.
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LocalityLoadBalancerSetting_Failover.
...
func (in *SLICanaryConfig) DeepCopyInto(out *SLICanaryConfig) {
	*out = *in
	out.AllowancePercent = in.AllowancePercent.DeepCopy()
	return
}
...
func (in *ServiceLevelObjective) DeepCopyInto(out *ServiceLevelObjective) {
	*out = *in
	...
	out.ObjectivePercent = in.ObjectivePercent.DeepCopy()
