...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"go.medium.engineering/picchu/pkg/apis/picchu/v1alpha1.ClusterCertificate":       schema_pkg_apis_picchu_v1alpha1_ClusterCertificate(ref),
		"go.medium.engineering/picchu/pkg/apis/picchu/v1alpha1.ClusterCertificateSpec":   schema_pkg_apis_picchu_v1alpha1_ClusterCertificateSpec(ref),
		"go.medium.engineering/picchu/pkg/apis/picchu/v1alpha1.ClusterCertificateStatus": schema_pkg_apis_picchu_v1alpha1_ClusterCertificateStatus(ref),
...
func schema_pkg_apis_picchu_v1alpha1_ClusterCertificate(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ClusterCertificate is the Schema for the clustercertificates API",
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
							Description: "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds",
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("go.medium.engineering/picchu/pkg/apis/picchu/v1alpha1.ClusterCertificateSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("go.medium.engineering/picchu/pkg/apis/picchu/v1alpha1.ClusterCertificateStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"go.medium.engineering/picchu/pkg/apis/picchu/v1alpha1.ClusterCertificateSpec", "go.medium.engineering/picchu/pkg/apis/picchu/v1alpha1.ClusterCertificateStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_picchu_v1alpha1_ClusterCertificateSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ClusterCertificateSpec defines the desired state of ClusterCertificate",
				Properties: map[string]spec.Schema{
					"source": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("go.medium.engineering/picchu/pkg/apis/picchu/v1alpha1.ClusterCertificateSource"),
						},
					},
					"target": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("go.medium.engineering/picchu/pkg/apis/picchu/v1alpha1.ClusterCertificateTarget"),
						},
					},
				},
		...
		Dependencies: []string{
			"go.medium.engineering/picchu/pkg/apis/picchu/v1alpha1.ClusterCertificateSource", "go.medium.engineering/picchu/pkg/apis/picchu/v1alpha1.ClusterCertificateTarget"},
	}
}

func schema_pkg_apis_picchu_v1alpha1_ClusterCertificateStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ClusterCertificateStatus defines the observed state of ClusterCertificate",
				Properties:  map[string]spec.Schema{},
			},
		},
		Dependencies: []string{},
