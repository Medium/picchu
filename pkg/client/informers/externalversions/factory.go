...
import (
	...
	picchu "go.medium.engineering/picchu/pkg/client/informers/externalversions/picchu"
...
type SharedInformerFactory interface {
	...
	Picchu() picchu.Interface
}

func (f *sharedInformerFactory) Picchu() picchu.Interface {
	return picchu.New(f, f.namespace, f.tweakListOptions)
}
